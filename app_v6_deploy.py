...
def render_team_wall(
    *,
    ...
    with c1: st.metric("🏆 已達標", f"{progress_levels['hit']} 人")
    with c2: st.metric("🔥 衝刺中", f"{progress_levels['rush']} 人")
    with c3: st.metric("🚧 穩定推進", f"{progress_levels['mid']} 人")
    with c4: st.metric("🌱 起步中", f"{progress_levels['start']} 人")
